...
public class BattlyCapePlugin extends JavaPlugin implements CommandExecutor {
    ...
    public void onEnable() {
        ...
        getLogger().info("BattlyCapePlugin habilitado! Versión 1.0.2");
        try {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        try {
            ...
            if (jsonResponse.getString("status").equals("OK")) {
                ...
                player.sendMessage(config.getString("messages.code-generated", "§aCódigo promocional generado: §f%code%").replace("%code%", code));
